...
ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Temporal\PythonProyect\PythonProcesos\build\assets\frame0")
DIRECTORIO_BASE = "C:/Temporal/SimuladorProcesos/json/procesos.json"
...
def mostrarProcesos():
    ...
    datos = ""
    with open(DIRECTORIO_BASE, 'r') as file:
        datos = file.read()
    with open(DIRECTORIO_BASE, 'w') as file:
        readJSON = json.loads(datos)
        json.dump(procesosJSON+readJSON, file, indent=4)
